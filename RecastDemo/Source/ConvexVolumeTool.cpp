...
void ConvexVolumeTool::handleMenu()
{
	...
	if (imguiCheck("PwngsBlock1", m_areaType == SAMPLE_PARTITION_BLOCK1))
		m_areaType = SAMPLE_PARTITION_BLOCK1;
	if (imguiCheck("PwngsBlock2", m_areaType == SAMPLE_PARTITION_BLOCK2))
		m_areaType = SAMPLE_PARTITION_BLOCK2;
	if (imguiCheck("PwngsBlock3", m_areaType == SAMPLE_PARTITION_BLOCK3))
		m_areaType = SAMPLE_PARTITION_BLOCK3;
	if (imguiCheck("PwngsBlock4", m_areaType == SAMPLE_PARTITION_BLOCK4))
		m_areaType = SAMPLE_PARTITION_BLOCK4;
	if (imguiCheck("PwngsBlock5", m_areaType == SAMPLE_PARTITION_BLOCK5))
		m_areaType = SAMPLE_PARTITION_BLOCK5;
	if (imguiCheck("PwngsBlock6", m_areaType == SAMPLE_PARTITION_BLOCK6))
		m_areaType = SAMPLE_PARTITION_BLOCK6;
	imguiUnindent();
