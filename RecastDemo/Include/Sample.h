...
enum SamplePolyAreas
{
	...
	SAMPLE_POLYAREA_BUILD,

	SAMPLE_PARTITION_DISABLE,  //not use
...
public:
	...
	void setSourceMeshName(const std::string& name) { m_souceMeshName = name; }
	std::string getSaveName(int saveType);
private:
